    ...
    <div className="app">
      ...
      >
        <section className="hero">
          ...
          <p>HAPPY BIRHTDAY TO THE MOST WONDERFUL HUMAN I HAVE EVER MET 💗</p>
        </section>
      ...
      >
        ...
        <button className="page-nav-btn" onClick={() => goToPage(4)}>
          📸 A PHOTO MONTAGE OF THE SPECIAL GIRL
        </button>
      </div>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">💖 Yours — Brijesh 💖</h2>
          <p className="final-subtitle">HAPPY BIRTHDAY RIYA  ✨</p>
        </section>
      </div>
